...
##' 
##' A function to estimate dust generation from Tertiary crusher activity.
##'
...
##' @param crusherCount Numeric value for the active Tertiary crusher unit in the quarry location. Use default to read the value in quarryInput dataframe.
##' 
##' @export
##' 
